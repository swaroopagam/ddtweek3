...
The R Markdown source code of this presentation can be found in this GitHub repository.
Data source and licence

This project uses the road safety data set, released by the United Kingdom's Department for Transport under the Open Government Licence.
